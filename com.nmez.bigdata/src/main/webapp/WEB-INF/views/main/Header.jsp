...
<body id="header">
	<nav class="navbar">
		...
		<!-- 로그인 시 로그아웃만 보이도록 작업 -->
			...
			<li hidden="hidden" id="update"><i class="fa-solid fa-user"></i> <a href="">정보수정</a></li>
			<li id="login"><i class="fa-solid fa-right-to-bracket"></i> <a href="">로그인</a></li>
			<li hidden="hidden" id="logout"><i class="fa-solid fa-right-from-bracket"></i> <a href="">로그아웃</a></li>
